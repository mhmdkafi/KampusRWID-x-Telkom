...
const CVUpload = ({ onUpload, isLoading }) => {
  ...
  const handleFileSelect = async (file) => {
    ...
    if (!allowedTypes.includes(file.type)) {
      showNotification(
        "Format file tidak didukung. Mohon upload file PDF atau Word.",
        "error"
      );
      return;
    }
  ...
  return (
    <div className="cv-upload-container">
      ...
      <div className="upload-header">
        ...
        <p>
          Unggah CV dalam format PDF atau Word untuk mendapatkan analisis dan
      ...
      <div className="upload-section">
        {!selectedFile ? (
          ...
          >
            ...
            <p>
              atau <span className="click-text">klik untuk pilih file</span>
            </p>
          ...
          <div className="file-preview">
            {existingCV && (
              <div className="replace-warning">
                ...
                <div>
                  <p>
                    <strong>Anda sudah memiliki CV:</strong>{" "}
                    {existingCV.filename}
                  </p>
                  <p className="text-muted">
                    File baru akan menggantikan CV yang lama.
                  </p>
                </div>
              </div>
            )}
